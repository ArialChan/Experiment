...
class SSIterator(object):
    ...
    def load_files(self):
        ...
        if self.mode == "cat_test":
            ...
            self.video_root_dir = "./exp/data/MSR-VTT/test/video_features/"  #/home/chc/PycharmProjects/chc_env/HACAModel/exp/data/MSR-VTT/train/video_features
            self.audio_root_dir = "./exp/data/MSR-VTT/test/audio_features/"
            self.pwc_root_dir = "./exp/data/MSR-VTT/test/pwc_features/"

        self.video_root_dir = "/home/chc/Downloads/LUNA_VIDEO/visual_features/"
        self.audio_root_dir = "/home/chc/Downloads/LUNA_VIDEO/audio_features/"
        self.pwc_root_dir = "/home/chc/Downloads/LUNA_VIDEO/pwc_features/"
        ...
        if self.mode == "test":
            self.video_list = self.video_list[67:77]
            print("test : ",self.video_list)
        elif self.mode == "valid":
            self.video_list = self.video_list[60:67]
